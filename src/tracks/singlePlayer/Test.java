...
public class Test {
    ...
    public static void main(String[] args) {
		...
		//FSM Agent 
		String FSMAgent = "FSMsingle.FSMAgent";
		
		String Astar = "tools.pathfinder.Agent";
		...
		//UNCOMMENT FOR FSM
		/*
		//switching levels when one level is beat or restarting game...
		...
		if (gameNotOver)
		{
			...
			for (int i = 0; i <= 6; i ++) 
			{
				...
				ArcadeMachine.runOneGame(game, level1, visuals, FSMAgent, recordActionsFile, seed, 0);
			}
		}
		*/
